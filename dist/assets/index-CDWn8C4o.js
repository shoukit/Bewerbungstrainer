...
`,o}async function je(t,i){const{totalSessions:n}=t;if(n<3){console.log("[CoachingIntelligence] New user - using welcome prompt");const a=xe();try{return{...await K(a),isWelcome:!0,generatedAt:new Date().toISOString()}}catch(h){return console.error("[CoachingIntelligence] Failed to generate welcome coaching:",h),ve()}}const l=be(i),o=ue(t)+`
`+l+`
