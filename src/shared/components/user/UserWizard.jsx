 ...
 *
 * After completion, updates user context and navigates to interview
 */
export default function UserWizard() {
  ...
  const [formData, setFormData] = useState({
    ...
    conversationStyle: user?.conversationStyle || 'professional'
  });
  ...
  /**
   * Moves to the next step or completes wizard
   */
  ...
  }, [step, totalSteps, formData, updateUser, navigate]);
            ...
            <div className="relative flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-ocean-blue-100 flex items-center gap-2">
                  ...
                  {user ? 'Möchtest du deine Daten aktualisieren?' : 'Erzähl uns ein bisschen über dich'}
                </p>
              </div>
            </div>
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div>
                  ...
                  <ConversationStyleSelector
                    ...
                    onStyleChange={(styleId) => handleInputChange('conversationStyle', styleId)}
                  />
                    ...
                    <div className="relative p-4 flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-ocean-deep-700">
                          Du kannst den Gesprächsstil auch während des Interviews anpassen.
                        </p>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center gap-3 p-3 bg-white/60 backdrop-blur-sm rounded-xl border border-white/60">
                        ...
                        <div className="flex-1">
                          ...
                          <span className="font-semibold text-slate-900 capitalize">
                            {formData.conversationStyle === 'friendly' ? '😊 Freundlich' :
                             formData.conversationStyle === 'critical' ? '🔍 Kritisch' :
                             '📋 Sachlich'}
                          </span>
                        </div>
                      </div>
