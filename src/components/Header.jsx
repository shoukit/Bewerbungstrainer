...
const Header = ({ userName, position, company }) => {
  return (
    <div className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-48 h-48 bg-purple-300/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2"></div>
      ...
      <div className="relative p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-3 hover:bg-white/15 transition-all duration-300">
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-purple-200 mb-0.5">Bewerber</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-3 hover:bg-white/15 transition-all duration-300">
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-purple-200 mb-0.5">Position</p>
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-3 hover:bg-white/15 transition-all duration-300">
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs text-purple-200 mb-0.5">Unternehmen</p>
        ...
        {/* Interviewer Info */}
        <div className="mt-4 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 backdrop-blur-sm rounded-xl p-4 border border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-400 to-pink-400 flex items-center justify-center shadow-lg">
              <Users className="w-5 h-5 text-white" />
            </div>
            <div>
              <p className="text-xs text-purple-100 mb-0.5">Dein Gesprächspartner</p>
