...
const RoleplaySession = ({ scenario, variables = {}, onEnd }) => {
  ...
  return (
    <>
      <div style={{ height: 'calc(100vh - 80px)' }} className="bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 p-4 overflow-hidden flex items-center justify-center">
