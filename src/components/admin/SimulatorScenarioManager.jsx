...
/**
 * SimulatorScenarioManager Component
 * Displays overview of simulator scenarios (Szenario-Training)
 */
export default function SimulatorScenarioManager({ onBack }) {
  ...
  const loadScenarios = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await wordpressAPI.adminGetSimulatorScenarios();
      if (response.success) {
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1 mb-3">
                Szenario-Training-Szenarien werden im WordPress-Adminbereich verwaltet.
                Hier sehen Sie eine Übersicht der vorhandenen Szenarien.
              </p>
              <Button
                variant="outline"
                size="sm"
                onClick={() => window.open('/wp-admin/edit.php?post_type=simulator_scenario', '_blank')}
                ...
                <div className="text-center py-8">
                  ...
                  {!searchQuery && (
                    <Button
                      variant="outline"
                      className="mt-4"
                      onClick={() => window.open('/wp-admin/post-new.php?post_type=simulator_scenario', '_blank')}
                    >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-xs text-[var(--text-muted)]">
                        ...
                        {scenario.questions_count && <span>{scenario.questions_count} Fragen</span>}
